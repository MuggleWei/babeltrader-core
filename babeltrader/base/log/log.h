...
#define BABELTRADER_LOG_LEVEL_TRACE MUGGLE_LOG_LEVEL_TRACE
#define BABELTRADER_LOG_LEVEL_DEBUG MUGGLE_LOG_LEVEL_DEBUG
#define BABELTRADER_LOG_LEVEL_INFO MUGGLE_LOG_LEVEL_INFO
#define BABELTRADER_LOG_LEVEL_WARNING MUGGLE_LOG_LEVEL_WARNING
#define BABELTRADER_LOG_LEVEL_ERROR MUGGLE_LOG_LEVEL_ERROR
#define BABELTRADER_LOG_LEVEL_FATAL MUGGLE_LOG_LEVEL_FATAL
...
#define LOG_LEVEL_TRACE BABELTRADER_LOG_LEVEL_TRACE
#define LOG_LEVEL_DEBUG BABELTRADER_LOG_LEVEL_DEBUG
#define LOG_LEVEL_INFO BABELTRADER_LOG_LEVEL_INFO
#define LOG_LEVEL_WARNING BABELTRADER_LOG_LEVEL_WARNING
#define LOG_LEVEL_ERROR BABELTRADER_LOG_LEVEL_ERROR
#define LOG_LEVEL_FATAL BABELTRADER_LOG_LEVEL_FATAL
